...
(function () {
  ...
  const TOWER_ART = {
    ...
    general:    { sil: 'general',    anim: 'mage' },
    captain:    { sil: 'captain',    anim: 'mage' },
    emperor:    { sil: 'emperor',    anim: 'blocker', scale: 1.06 },
    warlord:    { sil: 'warlord',    anim: 'blocker', scale: 1.12 },
    fallen:     { sil: 'fallen',     anim: 'blocker', scale: 1.15 },
