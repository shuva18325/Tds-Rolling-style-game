...
(function () {
  ...
  RS.MAPS = [
    M({ id: 'farmstead', name: 'Farmstead Road', order: 1,
    ...
    M({ id: 'riverford', name: 'Riverford Crossing', order: 2,
    ...
    M({ id: 'blackforest', name: 'The Black Forest', order: 3,
    ...
    M({ id: 'highkeep', name: 'Highkeep Battlements', order: 4,
    ...
    M({ id: 'frostvale', name: 'Frostvale Pass', order: 5,
    ...
    M({ id: 'sunkenbog', name: 'The Sunken Bog', order: 6,
    ...
    M({ id: 'ashen', name: 'Ashen Battlefield', order: 7,
    ...
    M({ id: 'aldermere', name: 'Ruins of Old Aldermere', order: 8,
    ...
    M({ id: 'dragonspine', name: "The Dragon's Spine", order: 9,
    ...
    M({ id: 'cathedral', name: 'Cathedral of Chains', order: 10,
    ...
    M({ id: 'obsidian', name: 'The Obsidian Gate', order: 11,
    ...
    M({ id: 'emberthrone', name: 'The Ember Throne', order: 12,
