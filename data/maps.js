...
(function () {
  ...
  RS.MAPS = [
    M({ id: 'farmstead', name: 'Farmstead Road', order: 1, signature: 'sig_scarecrow',
    ...
    M({ id: 'riverford', name: 'Riverford Crossing', order: 2, signature: 'sig_drowned',
    ...
    M({ id: 'blackforest', name: 'The Black Forest', order: 3, signature: 'sig_lurker',
    ...
    M({ id: 'highkeep', name: 'Highkeep Battlements', order: 4, signature: 'sig_wallbreaker',
    ...
    M({ id: 'frostvale', name: 'Frostvale Pass', order: 5, signature: 'sig_frostrevenant',
    ...
    M({ id: 'sunkenbog', name: 'The Sunken Bog', order: 6, signature: 'sig_boghorror',
    ...
    M({ id: 'ashen', name: 'Ashen Battlefield', order: 7, signature: 'sig_cinderfiend',
    ...
    M({ id: 'aldermere', name: 'Ruins of Old Aldermere', order: 8, signature: 'sig_rubblewight',
    ...
    M({ id: 'dragonspine', name: "The Dragon's Spine", order: 9, signature: 'sig_cliffharrier',
    ...
    M({ id: 'cathedral', name: 'Cathedral of Chains', order: 10, signature: 'sig_penitent',
    ...
    M({ id: 'obsidian', name: 'The Obsidian Gate', order: 11, signature: 'sig_magmabrute',
    ...
    M({ id: 'emberthrone', name: 'The Ember Throne', order: 12, signature: 'sig_thronesentinel',
